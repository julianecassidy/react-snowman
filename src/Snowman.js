...
function Snowman({
  ...
  return (
      <div className="Snowman">
        ...
        <p className="Snowman-nWrong">Wrong Guesses: {nWrong}</p>
        <p className="Snowman-word">{guessedWord()}</p>
        { nWrong === maxWrong && (
          <div>
            <p className="Snowman-keyboard hidden">
              {generateButtons()}</p>
            <p className="Snowman-outcome-message">You Lose!</p>
          </div>)
        }
        { nWrong !== maxWrong && (
          <p className="Snowman-keyboard">
            {generateButtons()}
          </p>)
        }
      </div>
